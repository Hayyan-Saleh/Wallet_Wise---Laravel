...
class AuthService
{
    ...
    public function otp(User $user, string $type = "verification"): Otp
    {
        ...
        $content = "Use this code to " . ($type == "verification" ? "verfiy your email " : "reset your password ") . "on Wallet Wise application";
        Mail::to($user->email)->send(new OtpMail($user, $otp, $content));
